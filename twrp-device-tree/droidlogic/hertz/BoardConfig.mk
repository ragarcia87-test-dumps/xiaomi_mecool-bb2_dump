...
DEVICE_PATH := device/droidlogic/hertz
...
TARGET_KERNEL_CONFIG := hertz_defconfig
TARGET_KERNEL_SOURCE := kernel/droidlogic/hertz
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 16752640
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 16752640
